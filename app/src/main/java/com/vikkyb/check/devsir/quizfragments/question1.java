    ...
    public void questionview()
    {
        d3.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                question = (String) dataSnapshot.child("question1").getValue();
                option1 = (String) dataSnapshot.child("options").child("question1").child("option1").getValue();
                option2 = (String) dataSnapshot.child("options").child("question1").child("option2").getValue();
                option3 = (String) dataSnapshot.child("options").child("question1").child("option3").getValue();
                option4 = (String) dataSnapshot.child("options").child("question1").child("option4").getValue();
                        ...
                        if (text.equals(firebaseanswer))
                        {
                            ...
                            mDatabaseUsers.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    newpost.child("score").setValue(c);
